export default function Footer () {
  return (
    <footer className="flex flex-col w-full bg-gradient-to-tr from-blue-500 to-blue-900">
      ...
      <div className="flex justify-end w-full px-6 py-6 mx-auto font-semibold xl:px-0 max-w-7xl">
